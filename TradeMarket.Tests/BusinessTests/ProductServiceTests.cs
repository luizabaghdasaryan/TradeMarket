    ...
    public class ProductServiceTests
    {
        ...
        public async Task ProductServiceDeleteAsyncDeletesProduct(int id)
        {
            ...
            mockUnitOfWork
               ...
               .ReturnsAsync(ProductEntities.First(c => c.Id == id));
            var productService = new ProductService(mockUnitOfWork.Object, UnitTestHelper.CreateMapperProfile());
        ...
        public async Task ProductServiceRemoveCategoryAsyncDeletesCategory(int id)
        {
            ...
            mockUnitOfWork
               .Setup(m => m.ProductCategoryRepository.GetByIdAsync(It.IsAny<int>()))
               .ReturnsAsync(ProductCategoryEntities.First(c => c.Id == id));
            var productService = new ProductService(mockUnitOfWork.Object, UnitTestHelper.CreateMapperProfile());
        ...
        public async Task ProductServiceUpdateAsyncUpdatesProduct()
        {
            ...
            mockUnitOfWork
               .Setup(m => m.ProductRepository.GetByIdAsync(It.IsAny<int>()))
               .ReturnsAsync(ProductEntities.First(c => c.Id == product.Id));
        ...
        public async Task ProductServiceUpdateCategoryAsyncUpdatesCategory()
        {
            ...
            var productService = new ProductService(mockUnitOfWork.Object, UnitTestHelper.CreateMapperProfile());
            var category = new ProductCategoryModel { Id = 6, CategoryName = "Name" };

            mockUnitOfWork
               .Setup(m => m.ProductCategoryRepository.GetByIdAsync(It.IsAny<int>()))
               .ReturnsAsync(ProductCategoryEntities.First(c => c.Id == category.Id));
